...
/// In this [ApiClient] class, [httpClient] is the only necessary component
...
class ApiClient {
  ...
  ///
  /// ```dart
  /// final headers = {ApiClient.user: someUserId};
  /// ```
  ...
  ///
  /// ```dart
  /// if (input.length == ApiClient.vinLength) return isValid = true;
  /// ```
  ...
  ///       .get(Uri.https('anyUrl'), headers: {ApiClient.user: someUserId});
  ///   // ...
  /// }
  /// ```
  final BaseClient httpClient = MockClient(
    (request) async {
